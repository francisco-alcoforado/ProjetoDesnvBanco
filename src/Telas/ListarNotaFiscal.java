 ...
 * @author lab01
 */
public class ListarNotaFiscal extends javax.swing.JInternalFrame {

    /**
     * Creates new form ListarNotaFiscals2
     */
    ...
    public final void montarTabela(){
        DefaultTableModel model;
            model = (DefaultTableModel) this.TabelaNotaFiscais.getModel();
            Fachada fachada = new Fachada();
            ArrayList<NotaFiscal> lista;
        
        try {
            lista = fachada.listarNotaFiscal();
            this.NotaFiscals = lista;
            int i = 0;
            for(NotaFiscal NotaFiscal : lista){
                Pedido pedido = NotaFiscal.getPedido();
                SimpleDateFormat sdf = new SimpleDateFormat("dd/MM/yyyy");
		String data = sdf.format(NotaFiscal.getData_Emissao());
                model.addRow(new Object[]{NotaFiscal.getCodigo(), NotaFiscal.getEmitente(), data, pedido.getCodigo(), pedido.getCliente().getNome()});
                i++;
            }
            TabelaNotaFiscais.setVisible(true);
        } catch (ClassNotFoundException ex) {
            Logger.getLogger(ListarNotaFiscal.class.getName()).log(Level.SEVERE, null, ex);
    ...
    private void initComponents() {
        ...
        TabelaNotaFiscais = new javax.swing.JTable();
        ...
        TabelaNotaFiscais.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {

            },
            new String [] {
                "Codigo", "Emitente", "Data_Emissao", "Codigo_Pedido", "Nome_Cliente"
            }
        ));
        jScrollPane1.setViewportView(TabelaNotaFiscais);
    ...
    private void editarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_editarActionPerformed
        int row = TabelaNotaFiscais.getSelectedRow();
        int codigo = (int) TabelaNotaFiscais.getValueAt(row, 0);
        NotaFiscal choosen = null;
        ...
        FormularioNotaFiscal form = new FormularioNotaFiscal(choosen);
    ...
    private void excluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_excluirActionPerformed
        try {
            ...
            int row = TabelaNotaFiscais.getSelectedRow();
            int codigo = (int) TabelaNotaFiscais.getValueAt(row, 0);
            fachada.removerNotaFiscal(codigo);
    ...
    private javax.swing.JTable TabelaNotaFiscais;
